...
public class AutoName_serviceLocator extends org.apache.axis.client.Service implements org.aurora_framework.www.schema.AutoName_service {
    ...
    private java.lang.String autoName_port_address = "http://delta.train.going-link.com/itf/modules/ws_eitf/PUR_CON/eitf_pur_contract_status_from_oa.svc";
    ...
    public org.aurora_framework.www.schema.AutoName_portType getautoName_port() throws javax.xml.rpc.ServiceException {
    ...
    public org.aurora_framework.www.schema.AutoName_portType getautoName_port(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            org.aurora_framework.www.schema.PUR_CONEitf_pur_contract_status_from_oaSvc_bindingStub _stub = new org.aurora_framework.www.schema.PUR_CONEitf_pur_contract_status_from_oaSvc_bindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (org.aurora_framework.www.schema.AutoName_portType.class.isAssignableFrom(serviceEndpointInterface)) {
                org.aurora_framework.www.schema.PUR_CONEitf_pur_contract_status_from_oaSvc_bindingStub _stub = new org.aurora_framework.www.schema.PUR_CONEitf_pur_contract_status_from_oaSvc_bindingStub(new java.net.URL(autoName_port_address), this);
                _stub.setPortName(getautoName_portWSDDServiceName());
                return _stub;
            }
        }
