...
public class AutoName_portTypeProxy implements com.delta.cgsqwsdl.AutoName_portType {
  private String _endpoint = null;
  private com.delta.cgsqwsdl.AutoName_portType autoName_portType = null;
  ...
  private void _initAutoName_portTypeProxy() {
    try {
      autoName_portType = (new com.delta.cgsqwsdl.AutoName_serviceLocator()).getautoName_port();
  ...
  public com.delta.cgsqwsdl.AutoName_portType getAutoName_portType() {
    if (autoName_portType == null)
      _initAutoName_portTypeProxy();
