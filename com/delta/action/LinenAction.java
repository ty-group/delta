 ...
 * 
 */
public class LinenAction extends BaseBean implements Action {
	public String execute(RequestInfo request) {
		...
		if("E".equals(ret)){
			...
			request.getRequestManager().setMessagecontent("布草写入异常,请通知管理员@!!!");
			lmdept.writeLog("布草写入失败...............................");
		}else{
			lmdept.writeLog("布草数据写入成功...................");
		}
