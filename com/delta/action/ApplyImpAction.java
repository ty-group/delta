 ...
 * 
 */
public class ApplyImpAction extends BaseBean implements Action {
	public String execute(RequestInfo request) {
		...
		if("E".equals(ret)){
			...
			request.getRequestManager().setMessagecontent("物资数据写入异常,请通知管理员@!!!");
			lmdept.writeLog("物资数据写入失败...............................");
		}else{
			lmdept.writeLog("物资数据写入成功...................");
		}
