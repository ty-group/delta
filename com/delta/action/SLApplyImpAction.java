 ...
 * 
 */
public class SLApplyImpAction extends BaseBean implements Action {
	public String execute(RequestInfo request) {
		...
		for (int i = 0; i < properties.length; i++) {
			...
			if(name.equals("sqbm")){
				//apply_organization_id = Util.null2String(value);
			}
			if(name.equals(" sqrq")){ 
		...
		try {
			comments=StrUtil.repNbsp(comments);
		...
		if("E".equals(ret)){
			...
			request.getRequestManager().setMessagecontent("物资申领写入异常,请通知管理员@!!!");
			lmdept.writeLog("物资申领写入失败...............................");
		}else{
			lmdept.writeLog("物资申领数据写入成功...................");
		}
